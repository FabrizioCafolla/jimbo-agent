...
<available_skills>
<skill>
<name>terraform-plan-reviewer</name>
<description>Specialized skill for deep review and risk assessment of Terraform plans. Use this to analyze `terraform plan` outputs, predict downtime, identify destructive changes, and validate security impact before applying.</description>
<location>.github/skills/terraform-plan-reviewer/SKILL.md</location>
</skill>
</available_skills>
</agent>
